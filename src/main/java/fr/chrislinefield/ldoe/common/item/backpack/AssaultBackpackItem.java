...
import fr.chrislinefield.ldoe.capability.AssaultBackpackInventoryCapability;
...
public class AssaultBackpackItem extends Item implements ICurioItem
{
    public AssaultBackpackItem() {
        ...
        if (entity instanceof ServerPlayer) {
            ...
            NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
                ...
                public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                    ...
                    return new AssaultBackpackMenu(id, inventory, packetBuffer);
                }
            }, (buf) -> {
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag compound) {
        return new AssaultBackpackInventoryCapability();
    }
