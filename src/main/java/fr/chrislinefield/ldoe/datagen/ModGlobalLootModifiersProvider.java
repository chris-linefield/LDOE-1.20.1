...
import fr.chrislinefield.ldoe.loot.AddItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        /*add("can_opener_from_zombie", new AddItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(new ResourceLocation("entities/zombie")).build() }, ModItems.CAN_OPENER.get()));*/
