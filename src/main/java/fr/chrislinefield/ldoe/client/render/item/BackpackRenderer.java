...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("ldoemod", "textures/entity/backpack.png");
    private final BackpackModel model;

    public BackpackRenderer() {
        this.model = new BackpackModel(Minecraft.getInstance().getEntityModels().bakeLayer(ModLayerDefinitions.BACKPACK));
    }
