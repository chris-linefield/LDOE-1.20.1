package fr.chrislinefield.ldoe.client.model;
...
public class GhillieSuitModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ghillie_suit"), "main");
